      ...
      <div className="p-8 flex flex-col flex-1">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {topics.slice(0, 4).map((topic) => (
            <span
              key={topic}
              className="px-4 py-2 bg-[#030712] border border-slate-800 text-slate-400 text-sm rounded-full font-mono hover:bg-rose-950/20 hover:text-rose-400 hover:border-rose-600/50 transition-all duration-300"
            >
              {topic}
            </span>
          ))}
