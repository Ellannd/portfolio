        ...
        <div className="max-w-7xl mx-auto px-4 py-8 lg:py-16 flex flex-col lg:flex-row gap-8 min-h-screen lg:min-h-0">
          ...
          <header className="shrink-0 w-full lg:w-1/4 lg:flex-1 lg:sticky lg:top-8 self-start h-fit lg:pt-20 lg:max-w-md">
            ...
            >
              <div className='flex flex-col items-center text-center'>
                ...
                <p className="text-slate-400 text-sm sm:text-base leading-relaxed font-mono">Systems Engineering Student</p>
                <p className="text-slate-400 text-sm sm:text-base leading-relaxed font-mono">Open National University, Venezuela.</p>
              </div>
              ...
              <div className="flex space-x-4 pt-4">
                ...
                <a href="https://github.com/Ellannd" className="w-10 h-10 border border-slate-400/30 rounded-lg flex items-center justify-center hover:border-rose-600 hover:text-rose-600 transition-all duration-300 group hover:scale-105">
                  <svg className="w-5 h-5 group-hover:-rotate-12 transition-transform" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-12 space-y-6">
                <h4 className="text-sm font-mono text-rose-400/80 tracking-widest uppercase">Core Technology Stack</h4>
                <div className="flex flex-wrap gap-8">
                  {[
                    { src: "https://cdn.simpleicons.org/nextdotjs/white", alt: "Next.js", label: "NEXT.JS" },
                    { src: "https://cdn.simpleicons.org/tailwindcss/06B6D4", alt: "Tailwind CSS", label: "TAILWIND" },
                    { src: "https://cdn.simpleicons.org/flutter/02569B", alt: "Flutter", label: "FLUTTER" },
                    { src: "https://cdn.simpleicons.org/django/092E20", alt: "Django", label: "DJANGO" },
                    { src: "https://cdn.simpleicons.org/python/3776AB", alt: "Python", label: "PYTHON" },
                    { src: "https://cdn.simpleicons.org/openjdk/EA2D2E", alt: "Java", label: "JAVA" },
                    { src: "https://cdn.simpleicons.org/bootstrap/7952B3", alt: "Bootstrap", label: "BOOTSTRAP" },
                  ].map(({ src, alt, label }) => (
                    <div key={label} className="group flex flex-col items-center gap-3">
                      <div className="relative w-24 h-24 rounded-full bg-slate-900/50 border border-slate-800 flex items-center justify-center transition-all duration-500 group-hover:border-rose-600/50 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(225,29,72,0.3)] overflow-hidden">
                        <img src={src} alt={alt} className="w-12 h-12 transition-all duration-500 grayscale group-hover:grayscale-0 group-hover:scale-110" />
                      </div>
                      <span className="text-xs font-mono text-slate-500 group-hover:text-rose-400 transition-colors tracking-tighter">{label}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <main className="w-full lg:w-3/4 lg:flex-1 lg:flex lg:flex-col space-y-16 lg:space-y-40 mt-8 lg:mt-0">
            <section id="about" className="scroll-motion">
              ...
              >
                <Typewriter text="As a Systems Engineering student, I am dedicated to building digital solutions that merge robust technical logic with seamless user experiences. My primary focus lies in Full Stack Development, where I enjoy transforming complex ideas into functional, high-quality applications. I thrive at the intersection of problem-solving and clean design, always aiming to develop software that is as efficient as it is intuitive." delay={40} />
              </motion.p>
            </section>
                ...
                {[
                  {
                    ...
                    description: "Developing web applications while studying in College.",
                    delay: 0.1,
                  },
                  {
                    title: "Web Developer & Graphic Designer",
                    company: "GeneraERNC | 2022 - 2023",
                    description: "Developed the corporate website using WordPress and managed databases for real-time product updates. Responsible for brand identity design and digital marketing campaigns.",
                    delay: 0.1,
                  },
                  {
                    title: "Administrative Developer",
                    company: 'Hotel "La Pichincha" | 2021 - 2022',
                    description: "Engineered custom resource management software to optimize inventory and administrative workflows. Automated data entry processes and guest information management.",
                    delay: 0.2,
                  },
                ].map((exp) => (
                  <motion.article
                  ...
                  >
                    <h3 className="text-2xl font-semibold text-slate-100 mb-2 hover:text-rose-600 transition-colors duration-300 font-mono">{exp.title}</h3>
